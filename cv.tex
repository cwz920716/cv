...
I am interested in building high-performance, energy-efficient computer systems. My current research focus is on developing advanced compiler and runtime support for emerging programming models and hardware platforms, specifically focusing on dataflow programming and event-driven programming. 
...
\begin{itemize}[leftmargin=*] \itemsep -4pt
	\item Programming Languages: C/C++, Java, JavaScript, Python
	\item Hardware Description Language: Verilog, Bluespec Verilog
	\item System Software Development: Unix/Linux OS, Node.js, LLVM, Coq
\end{itemize}
...
\vspace*{-7pt}
Compiler/Runtime Support for Dataflow Programming in Scalable Machine Learning \hfill(Ongoing)\\
\vspace*{-10pt}
\begin{itemize}[leftmargin=*] \itemsep -3pt
\vspace*{-5pt}
	\item Characterizing the hardware/software implications of the dataflow programming models used in scalable machine learning systems such as Tensorflow
	\item (Future work) Developing modularized compiler and runtime optimization passes for scalable dataflow programming on hetergeneous hardware platform
\end{itemize}
